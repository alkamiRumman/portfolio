        ...
        <div className="min-h-screen flex items-center justify-center py-20">
            <RevealOnScroll>
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="rounded-xl p-8 border-gray-200 dark:border-white/10 border bg-white dark:bg-transparent hover:-translate-y-1 transition-all shadow-sm dark:shadow-none">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="p-6 rounded-xl border-gray-200 dark:border-white/10 border bg-white dark:bg-transparent hover:-translate-y-1 transition-all shadow-sm dark:shadow-none">
                        ...
                        <div className="p-6 rounded-xl border-gray-200 dark:border-white/10 border bg-white dark:bg-transparent hover:-translate-y-1 transition-all shadow-sm dark:shadow-none">
                            <h3 className="text-xl font-bold mb-4 text-gray-800 dark:text-white"> 💼 Work Experience </h3>
